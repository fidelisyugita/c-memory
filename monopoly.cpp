...
{
  gotoxy(0, 1);
  printf("|     Bebas    Setiabudhi |   Ledeng   |            |   %c%c%c%c%c%c   |    PDAM    |  Sukajadi  |  Cipaganti |            |", 31, 31, 31, 31, 31, 31);
  gotoxy(0, 2);
  printf("|  Parkir                 |            | Mimilikan  |            |            |            |            | Pengadilan |");
  gotoxy(0, 5);
  printf("                                                         %c%c%c%c                                                         ", 31, 31, 31, 31);
  gotoxy(0, 7);
  printf("|                                                                                                       |            |");
  gotoxy(0, 8);
  printf("|    Coin                                                                                               |    Games   |");
  gotoxy(0, 13);
  printf("| Ciumbuleuit                                                                                           |   Cibodas  |");
  gotoxy(0, 20);
  printf("|  Mimilikan                                                                                            |  Mimilikan |");
  gotoxy(0, 21);
  printf("|                                                                                                       |            |");
  gotoxy(0, 25);
  printf("|   Cisitu                                                                                              |    Dago    |");
  gotoxy(0, 31);
  printf("|  Terminal                                                                                             |   Bandara  |");
  gotoxy(0, 32);
  printf("|                                                                                                       |            |");
  gotoxy(0, 37);
  printf("| Setra Duta                                                                                            | Padjajaran |");
  gotoxy(0, 43);
  printf("|  Antapani                                                                                             |  Cicaheum  |");
  gotoxy(0, 49);
  printf("|                                                                                                       |            |");
  gotoxy(0, 50);
  printf("|   Games                                                                                               |    Coin    |");
  gotoxy(0, 55);
  printf("|              Cihanjuang | Parongpong |    PLN     |    %c%c%c%c    |            |  Gerlong   |  Sarijadi  |   Mulai    |", 30, 30, 30, 30);
  gotoxy(0, 56);
  printf("|   Penjara               |            |            |            |  Mimilikan |            |            |            |");
  gotoxy(0, 59);
  printf("|                         |            |            |   %c%c%c%c%c%c   |            |            |            |            |", 30, 30, 30, 30, 30, 30);
...
void tamp_pemain(int pindah, int urutan, int bidak, int cord_y)
{
  ...
  {
  case 0:
    gotoxy(urutan - 2 + 111, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 1:
    gotoxy(urutan - 2 + 98, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 2:
    gotoxy(urutan - 2 + 85, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 3:
    gotoxy(urutan - 2 + 72, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 4:
    gotoxy(urutan - 2 + 59, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 5:
    gotoxy(urutan - 2 + 46, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 6:
    gotoxy(urutan - 2 + 33, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 7:
    gotoxy(urutan - 2 + 20, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 8:
    gotoxy(urutan - 2 + 7, 57 + cord_y);
    printf("%c", bidak);
    break;
  case 9:
    gotoxy(urutan - 2 + 7, 51 + cord_y);
    printf("%c", bidak);
    break;
  case 10:
    gotoxy(urutan - 2 + 7, 45 + cord_y);
    printf("%c", bidak);
    break;
  case 11:
    gotoxy(urutan - 2 + 7, 39 + cord_y);
    printf("%c", bidak);
    break;
  case 12:
    gotoxy(urutan - 2 + 7, 33 + cord_y);
    printf("%c", bidak);
    break;
  case 13:
    gotoxy(urutan - 2 + 7, 27 + cord_y);
    printf("%c", bidak);
    break;
  case 14:
    gotoxy(urutan - 2 + 7, 21 + cord_y);
    printf("%c", bidak);
    break;
  case 15:
    gotoxy(urutan - 2 + 7, 15 + cord_y);
    printf("%c", bidak);
    break;
  case 16:
    gotoxy(urutan - 2 + 7, 9 + cord_y);
    printf("%c", bidak);
    break;
  case 17:
    gotoxy(urutan - 2 + 7, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 18:
    gotoxy(urutan - 2 + 20, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 19:
    gotoxy(urutan - 2 + 33, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 20:
    gotoxy(urutan - 2 + 46, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 21:
    gotoxy(urutan - 2 + 59, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 22:
    gotoxy(urutan - 2 + 72, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 23:
    gotoxy(urutan - 2 + 85, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 24:
    gotoxy(urutan - 2 + 98, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 25:
    gotoxy(urutan - 2 + 111, 3 + cord_y);
    printf("%c", bidak);
    break;
  case 26:
    gotoxy(urutan - 2 + 111, 9 + cord_y);
    printf("%c", bidak);
    break;
  case 27:
    gotoxy(urutan - 2 + 111, 15 + cord_y);
    printf("%c", bidak);
    break;
  case 28:
    gotoxy(urutan - 2 + 111, 21 + cord_y);
    printf("%c", bidak);
    break;
  case 29:
    gotoxy(urutan - 2 + 111, 27 + cord_y);
    printf("%c", bidak);
    break;
  case 30:
    gotoxy(urutan - 2 + 111, 33 + cord_y);
    printf("%c", bidak);
    break;
  case 31:
    gotoxy(urutan - 2 + 111, 39 + cord_y);
    printf("%c", bidak);
    break;
  case 32:
    gotoxy(urutan - 2 + 111, 45 + cord_y);
    printf("%c", bidak);
    break;
  case 33:
    gotoxy(urutan - 2 + 111, 51 + cord_y);
    printf("%c", bidak);
    break;
  }
}
...
void kocok_dadu(int urutan, int *dadu1, int *dadu2)
{
  ...
  gotoxy(42, 25);
  printf("            Pemain %d%c%c          ", urutan + 1, 179, urutan + 3);
  gotoxy(42, 26);
  printf("           Kocok dadu !          ");
  gotoxy(42, 27);
  printf("        Tekan tombol spasi      ");
  getch();
  srand(time(NULL));
  for (i = 0; i < 10; i++)
  {
  ...
  gotoxy(42, 33);
  printf("Anda bergerak sebanyak %d langkah", *dadu1 + *dadu2);
  while (pindah <= pemain[urutan].gerak)
  {
    ...
    if (pindah >= 34)
    {
      ...
      gotoxy(42, 34);
      printf("Melewati Mulai");
      gotoxy(42, 34);
      printf("Uang bertambah sebanyak $200");
      Sleep(30);
...
void penjara(int urutan)
{
  ...
  {
    gotoxy(1, 55);
    printf(" %c%c%c%c%c%c%c%c%c%c", 31, 31, 31, 31, 31, 31, 31, 31, 31, 31);
    gotoxy(1, 56);
    printf("%c", 16);
    gotoxy(1, 57);
    printf("%c", 16);
    ...
    printf("%c", 16);
    gotoxy(1, 59);
    printf(" %c%c%c%c%c%c%c%c%c%c", 30, 30, 30, 30, 30, 30, 30, 30, 30, 30);
    gotoxy(12, 56);
    printf("%c", 17);
    gotoxy(12, 57);
    printf("%c", 17);
  ...
  else
  {
    if (pemain[urutan].uang > 200)
    {
      ...
      do
      {
        ...
        printf("1. Bayar $200");
        gotoxy(42, 27);
        printf("2. Keberuntungan");
        gotoxy(42, 25);
        printf("Pilih cara kabur : ");
        pilih = getch();
      ...
      if (pilih == '1')
      {
        ...
        pemain[urutan].uang -= 200;
        gotoxy(42, 25);
        printf("Uang anda berkurang $200");
        gotoxy(42, 26);
        printf("Anda bebas dari penjara");
        getch();
        gotoxy(17, 7);
...
void mimilikan(int urutan, int giliran)
{
  ...
  case 14:
    printf("              SELAMAT             ");
    gotoxy(17, 49);
    printf("    AMBIL UANG SETIAP PEMAIN!     ");
    getch();
    for (int i = 0; i < jum_pem; i++)
    {
      pemain[i].uang -= 30;
  ...
  case 15:
    printf("               ASIK!              ");
    gotoxy(17, 49);
    printf("   HANCURKAN TANAH PEMAIN LAWAN   ");
    getch();
  ...
  case 16:
    printf("              SELAMAT             ");
    gotoxy(17, 49);
    printf("    DAPAT KARTU BEBAS PENJARA!    ");
    getch();
  ...
  default:
    ...
    if (y > 1)
    {
      ...
      do
      {
        ...
        printf("                                      ");
        gotoxy(42, 25);
        printf("Pilih tanah yang mau dihancurkan: ");
        scanf("%d", &jawab);
    ...
    {
      gotoxy(42, 25);
      printf("Tidak ada tanah yang bisa dihancurkan");
    }
    getch();
    break;
  }
...
void rumah(int urutan, int nomor)
{
  ...
  {
    gotoxy(42, 25);
    printf("Tanah belum ada pemilik");
    do
    {
      gotoxy(42, 27);
      printf("Harga tanah : $%d", tanah[nomor].harga_beli / 2);
      gotoxy(42, 26);
      printf("Apakah anda ingin membeli? (Y/T)");
      pilih = getch();
    ...
    if (pilih == 'y' || pilih == 'Y')
    {
      if (pemain[urutan].uang < tanah[nomor].harga_beli / 2)
      {
        clear();
        gotoxy(42, 25);
        printf("Uang anda tidak cukup membeli ini");
      }
      else
      {
        clear();
        ...
        gotoxy(42, 25);
        printf("Tanah ini menjadi milik anda");
        ...
        if (pemain[urutan].putaran > 0)
        {
          ...
          {
            gotoxy(42, 27);
            printf("A. 1 Rumah : $%d", tanah[nomor].harga_beli);
            gotoxy(42, 28);
            printf("B. 2 Rumah : $%d", tanah[nomor].harga_beli * 2);
            gotoxy(42, 29);
            printf("C. Hotel   : $%d", tanah[nomor].harga_beli * 3);
            gotoxy(42, 26);
            printf("Masukkan tambahan yang di inginkan");
            pilih = getch();
  ...
  {
    gotoxy(42, 25);
    printf("Tanah sudah dimiliki Pemain %d%c%c", tanah[nomor].no_pemilik + 1, 179, tanah[nomor].no_pemilik + 3);
    gotoxy(42, 26);
    printf("Anda harus membayar sebanyak $%d", tanah[nomor].harga_sewa / 2 * tanah[nomor].upgrade);
    getch();
    if (pemain[urutan].uang < tanah[nomor].harga_sewa / 2 * tanah[nomor].upgrade)
    {
      ...
      if (pilih == '2')
      {
        ...
        if (setuju == 1)
        {
          ...
          printf("Anda beruntung");
          gotoxy(42, 26);
          printf("Berhasil membujuk Pengadilan");
        ...
        else
        {
          ...
          printf("Anda belum beruntung");
          gotoxy(42, 26);
          printf("Tidak bisa membujuk Pengadilan");
          gotoxy(42, 28);
          printf("Jual tanah!");
        }
        getch();
        ...
        do
        {
          ...
          if (y > 1)
          {
            ...
            do
            {
              ...
              printf("                                ");
              gotoxy(42, 25);
              printf("Pilih tanah yang mau dijual: ");
              scanf("%d", &jawab);
            } while (jawab > y - 1 || jawab < 1);
          ...
          {
            gotoxy(42, 25);
            printf("Tidak ada tanah yang bisa dijual");
            gotoxy(42, 26);
  ...
  {
    gotoxy(42, 25);
    printf("Tanah ini milik anda");
    if (tanah[nomor].upgrade < 2)
    {
      do
      {
        gotoxy(42, 26);
        printf("Anda ingin upgrade? (Y/T)");
        pilih = getch();
      } while (pilih != 'y' && pilih != 'Y' && pilih != 'T' && pilih != 't');
      if (pilih == 'y' || pilih == 'Y')
      {
  ...
  gotoxy(42, 30);
  printf("Tekan spasi untuk lanjut");
  getch();
}
//======================================================================
void rumah2(int urutan, int nomor)
{
  ...
  if (tanah2[nomor].pemilik == false)
  {
    ...
    {
      gotoxy(42, 27);
      printf("Harga tanah : $%d", tanah2[nomor].harga_beli);
      gotoxy(42, 26);
      printf("Apakah anda ingin membeli? (Y/T)");
      pilih = getch();
    } while (pilih != 'y' && pilih != 'Y' && pilih != 'T' && pilih != 't');
  ...
  {
    gotoxy(42, 25);
    printf("Tanah sudah dimiliki Pemain %d%c%c", tanah2[nomor].no_pemilik + 1, 179, tanah2[nomor].no_pemilik + 3);
    gotoxy(42, 26);
    printf("Anda harus membayar sebanyak $%d", tanah2[nomor].harga_sewa * tanah2[nomor].upgrade);
    getch();
  ...
  else
  {
    ...
    gotoxy(42, 26);
    printf("Harga sewa $%d", tanah2[nomor].harga_sewa * tanah2[nomor].upgrade);
  }
  gotoxy(42, 30);
  printf("Tekan spasi untuk lanjut");
  getch();
...
void petak(int urutan)
{
  ...
  else if (pemain[urutan].gerak == 16 || pemain[urutan].gerak == 33)
  {
    ...
    if (pemain[urutan].uang > 200)
    {
      ...
      {
        gotoxy(42, 36);
        printf("Hore!! Kamu memenangkan uang sebesar $200");
        pemain[urutan].uang += 200;
      }
      else
      {
        gotoxy(42, 36);
        printf("Maaf anda kehilangan uang sebesar $200");
        pemain[urutan].uang -= 200;
      }
    }
    else
    {
      gotoxy(42, 25);
      printf("Uang anda tidak cukup untuk menebak");
    }
    getch();
  }
  else if (pemain[urutan].gerak == 9 || pemain[urutan].gerak == 26)
  {
    ...
    if (pemain[urutan].uang > 100)
    {
      ...
      {
        gotoxy(42, 22);
        printf("Menebak angka dadu yang akan tampil");
        gotoxy(42, 23);
        printf("Masukkan tebakan anda : (1-6)");
        pilih = getch();
      ...
      {
        gotoxy(42, 36);
        printf("Hore!! Kamu memenangkan uang sebesar $300");
        pemain[urutan].uang += 300;
      }
      else
      {
        gotoxy(42, 36);
        printf("Maaf anda kehilangan uang sebesar $100");
    ...
    {
      gotoxy(42, 25);
      printf("Uang anda tidak cukup untuk bermain");
    }
    getch();
  }
  ...
  else if (pemain[urutan].gerak == 25)
  {
    ...
    {
      gotoxy(42, 22);
      printf("Uang berlebih");
      gotoxy(42, 23);
      printf("Anda harus bayar denda");
      gotoxy(42, 24);
      printf("Uang berkurang $200");
      pemain[urutan].uang -= 200;
    }
    else
    {
      gotoxy(42, 22);
      printf("Terlalu miskin");
      gotoxy(42, 23);
      printf("Anda harus diberikan bantuan");
      gotoxy(42, 24);
      printf("Uang bertambah $100");
      pemain[urutan].uang += 100;
    }
    getch();
  }
...
void menang()
{
  ...
  printf("              Hore!            ");
  gotoxy(42, 26);
  printf("        Pemain %d%c%c menang   ", max + 1, 179, max + 3);
  gotoxy(42, 27);
  printf("      Dengan uang terbanyak    ");
  getch();
}
//======================================================================
int main()
